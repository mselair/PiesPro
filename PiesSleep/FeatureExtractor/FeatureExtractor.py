...
.. code-block:: python
    ...
    from PiesSleep.FeatureExtractor.SpectralFeatures import mean_bands, relative_bands
...
class SleepSpectralFeatureExtractor:
    ...
    ------
    v0.1.0 Updates
    - communication between functions (Pxx, fs, ...) changed to ObjDict - see PiesSleep.types.ObjDict
    ...
    v0.2.0
        - methods buffer, PSD transferred into PiesSleep.PiesUtils.signal
    ...
    v1.0.0
        ...
        - feature extraction functions were moved into PiesSleep.FeatureExtractor.SpectralFeatures
