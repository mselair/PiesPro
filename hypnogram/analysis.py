...
def get_transition_counts(hyp, states=['WAKE', 'N1', 'N2', 'N3', 'REM']):
...
def get_transition_matrix(hyp, states=['WAKE', 'N1', 'N2', 'N3', 'REM']):
...
def get_transition_matrix_dataset(hypnograms, states=['WAKE', 'N1', 'N2', 'N3', 'REM']):
    ms = []
